...
<div class="title_homepage d-flex">
    <div class="d-flex flex-column col-6 align-items-center justify-content-center">
        ...
        <button class="btn_appoint" type="button">Записаться на прием</button>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="d-flex flex-row">
            <ul class="d-flex flex-column col-md-4">
                @foreach($villages as $region)
                    <li class="udm_item" href="">{{$region}}</li>
                @endforeach
            </ul>
            <ul class="d-flex flex-column col-md-4">
                <li class="udm_item" href="">Алнаши</li>
                <li class="udm_item" href="">Алнаши</li>
                <li class="udm_item" href="">Алнаши</li>
                <li class="udm_item" href="">Алнаши</li>
                <li class="udm_item" href="">Алнаши</li>
